...
#[ORM\Entity]
#[ORM\Table(name: 'project_actors')]
#[ORM\Index(name: 'idx_project_actor_project', columns: ['project_id'])]
#[ORM\Index(name: 'idx_project_actor_actor', columns: ['actor_id'])]
class ProjectActor
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function __construct(Project $project, Actor $actor)
    {
